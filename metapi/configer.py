...
class metaconfig:
    ...
    sub_dirs = [
        ...
        "logs/06.identify_phamb_postprocess",
        "logs/07.predict_scaftigs_gene_prodigal",
        "logs/07.predict_scaftigs_gene_prokka",
        "logs/07.predict_scaftigs_gene_prokka_multiqc",
        "logs/07.predict_mags_gene_prodigal",
        "logs/07.predict_mags_gene_prokka",
        "logs/07.predict_mags_gene_prokka_multiqc",
        "logs/07.annotation_prophage_dbscan_swa_prepare",
        "logs/07.annotation_prophage_dbscan_swa",
        "logs/07.annotation_prophage_dbscan_swa_merge",
        "logs/07.annotation_prophage_dbscan_swa_distribute",
        ...
        "logs/11.databases_bacteriome_krakenuniq_build",
        "logs/11.databases_bacteriome_krakenuniq_bracken_build",
