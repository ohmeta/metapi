rule dereplicate_mags_drep:
    ...
    log:
        os.path.join(config["output"]["dereplicate"], "logs/dereplicate_mags_drep/{assembler}.log")
    benchmark:
        os.path.join(config["output"]["dereplicate"], "benchmark/dereplicate_mags_drep/{assembler}.txt")
    params:
...
rule dereplicate_mags_galah:
    ...
    log:
        os.path.join(config["output"]["dereplicate"], "logs/dereplicate_mags_galah/{assembler}.log")
    benchmark:
        os.path.join(config["output"]["dereplicate"], "benchmark/dereplicate_mags_galah/{assembler}.txt")
    params:
