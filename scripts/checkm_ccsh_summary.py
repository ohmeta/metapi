...
"""
    ...
    a checkm completeness, contamination and strain heterogeneity summary for many samples
...
def get_checkm_out(checkmout_list, out_tsv):
    headers = ["sample_id", 
               "bin_number", 
               "completeness_ge70_num", "completeness_ge80_num", "completeness_ge90_num",
               "completeness_ge70_rate", "completeness_ge80_rate", "completeness_ge90_rate",
               "contamination_le30_num", "contamination_le20_num", "contamination_le10_num",
               "contamination_le30_rate", "contamination_le20_rate", "contamination_le10_rate",
               "strain_heterogeneity_100_num", "strain_heterogeneity_100_rate"]
    samples_bin_info = []
    with open(checkmout_list, "r") as list_handle:
        for checkmout in list_handle:
            bin_info = {}
            bin_info["sample_id"] = os.path.basename(checkmout.strip()).split(".")[0]
            ...
            with open(checkmout.strip(), 'r') as checkmout_handle:
                ...
                bin_info["completeness_ge70_rate"] = bin_info["completeness_ge70_num"] / bin_info["bin_number"]
                bin_info["completeness_ge80_rate"] = bin_info["completeness_ge80_num"] / bin_info["bin_number"]
                bin_info["completeness_ge90_rate"] = bin_info["completeness_ge90_num"] / bin_info["bin_number"]
                bin_info["contamination_le30_rate"] = bin_info["contamination_le30_num"] / bin_info["bin_number"]
                bin_info["contamination_le20_rate"] = bin_info["contamination_le20_num"] / bin_info["bin_number"]
                bin_info["contamination_le10_rate"] = bin_info["contamination_le10_num"] / bin_info["bin_number"]
                bin_info["strain_heterogeneity_100_rate"] = bin_info["strain_heterogeneity_100_num"] / bin_info["bin_number"]
...
def main():
    parser = argparse.ArgumentParser(description='summary checkm results: completeness, contamination, strain heterogeneity for many samples')
