...
<<<<<<< HEAD
    ...
    parser.add_argument(
        "--tax_list",
        "a file contain species taxonmy lineages"
    )
    parser.add_argument("--print", action='store_true', "print download shell")
    parser.add_argument("--download", action='store_true', "just download")
